...
export PANDA_CFG="http://t3serv001.mit.edu/~snarayan/histcatalog/20170501_redpanda.cfg"
...
export SUBMIT_OUTDIR="/mnt/hadoop/scratch/snarayan/redpanda/"${SUBMIT_NAME}"/"
