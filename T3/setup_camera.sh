...
export PANDA_CFG="http://t3serv001.mit.edu/~snarayan/histcatalog/20170520_camera.cfg"
...
export SUBMIT_OUTDIR="/mnt/hadoop/cms/store/user/snarayan/store/redpanda/camera_"${SUBMIT_NAME}"/"
